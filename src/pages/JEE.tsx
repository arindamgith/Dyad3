...
import { BookOpen, Clock, Users, Calendar, Award, Target } from "lucide-react";
...
const JEEPage = () => {
  const courses = [
    ...
    },
    {
      ...
      mode: "Online & Offline",
      students: "40+",
      description: "Intensive preparation for JEE Main for droppers",
      features: [
  ...
  const features = [
    {
      ...
      description: "Well-researched and structured study material covering entire JEE syllabus"
    },
    {
      icon: <Target className="text-green-600" size={24} />,
      title: "Targeted Practice",
      description: "Topic-wise and level-wise practice problems for better understanding"
    },
    {
      icon: <Award className="text-purple-600" size={24} />,
      title: "Performance Analysis",
      description: "Detailed analysis of test performance to identify weak areas"
    },
    {
      icon: <Users className="text-yellow-600" size={24} />,
      title: "Expert Faculty",
      description: "Highly qualified faculty with proven track record in JEE coaching"
    }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <Badge className="mb-4 bg-white text-blue-600 hover:bg-white">JEE Preparation</Badge>
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Crack JEE with <span className="text-yellow-300">Improvise Academy</span>
          </h1>
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Comprehensive coaching programs for JEE Main & Advanced with proven results
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose Our JEE Program?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our specialized approach ensures comprehensive preparation for JEE Main & Advanced
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Our JEE Courses</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              ...
              <Card key={course.id} className="flex flex-col h-full relative">
                ...
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    <Badge variant="secondary">JEE</Badge>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Book Your Free JEE Demo Class</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Experience our teaching methodology and see why we're Kolkata's top choice for JEE preparation
              </p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Crack JEE?</h2>
